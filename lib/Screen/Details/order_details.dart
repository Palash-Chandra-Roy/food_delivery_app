...
class OrderDetails extends StatefulWidget {
  ...
  OrderDetails({required this.image, required this.name, required this.price});
                  ...
                  GestureDetector(
                    onTap: () async {
                      if (address == null) {
                        ...
                        await DatabaseMethods().addAdminDetails(
                          userOrderMap,
                          orderId,
                        );
    ...
    try {
      await Stripe.instance
          ...
          .then((value) async {
            ...
            await DatabaseMethods().addAdminDetails(userOrderMap, orderId);
